...
with_overrides(function (override) {
    ...
    global.with_stub(function (bot_stub) {
        global.with_stub(function (bot_services_stub) {
            global.with_stub(function (admin_stub) {
                override('bot_data.add', bot_stub.f);
                override('bot_data.add_bot_services', bot_services_stub.f);
                override('settings_users.update_user_data', admin_stub.f);
                dispatch(event);
                var args = bot_stub.get_args('bot');
                assert_same(args.bot, event.bot);

                var bot_services_args = bot_services_stub.get_args('bot_services');
                assert_same(bot_services_args.bot_services, event.bot_service);
    ...
    global.with_stub(function (bot_stub) {
        global.with_stub(function (bot_service_stub) {
            global.with_stub(function (admin_stub) {
                override('bot_data.update', bot_stub.f);
                override('bot_data.update_bot_service', bot_service_stub.f);
                override('settings_users.update_user_data', admin_stub.f);
                ...
                var bot_service_args = bot_service_stub.get_args('email', 'bot_service_update');
                assert_same(bot_service_args.email, event.bot.email);
                assert_same(bot_service_args.bot_service_update, event.bot_service);
