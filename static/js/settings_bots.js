...
exports.set_up = function () {
    ...
    $("#active_bots_list").on("click", "button.open_edit_bot_form", function (e) {
        ...
        if (bot_type === OUTGOING_WEBHOOK) {
            var bot_service = bot_data.get_bot_service(bot_email);
            $("#settings_page .edit_bot #service_data").show();
            $("#settings_page .edit_bot #edit_service_base_url").val(bot_service.base_url);
            $("#settings_page .edit_bot #edit_service_interface").val(bot_service.interface);
        } else {
